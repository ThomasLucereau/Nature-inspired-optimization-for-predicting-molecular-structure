...
temp_initial = 1000
taux_descente = 0.99  # Ralentissement de l'algorithme
n_etapes = 1000
...
# Création de la figure pour le graphique 3D
...
# Création de la figure pour le tracé de la fonction
ax2 = fig.add_subplot(122)
ax2.set_xlabel('X')
ax2.set_ylabel('Y')
ax2.set_title('Fonction à minimiser')

# Données pour le tracé de la fonction
